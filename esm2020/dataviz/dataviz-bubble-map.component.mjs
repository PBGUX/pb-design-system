...
PbdsDatavizBubbleMapComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.1.0", ngImport: i0, type: PbdsDatavizBubbleMapComponent, deps: [{ token: i0.ElementRef }, { token: i1.ViewportScroller }, { token: i2.PbdsDatavizService }], target: i0.ɵɵFactoryTarget.Component });
