...
class PbdsFeedbackRatingComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: PbdsFeedbackRatingComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "16.2.12", type: PbdsFeedbackRatingComponent, selector: "pbds-feedback-rating", inputs: { ariaLabels: "ariaLabels", color: "color" }, providers: [
            {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: PbdsFeedbackRatingComponent, decorators: [{
            type: Component,
