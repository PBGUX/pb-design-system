...
PbdsEmptyStateModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.2", ngImport: i0, type: PbdsEmptyStateModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
PbdsEmptyStateModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.1.2", ngImport: i0, type: PbdsEmptyStateModule, declarations: [PbdsEmptyStateComponent], imports: [CommonModule], exports: [PbdsEmptyStateComponent] });
PbdsEmptyStateModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.1.2", ngImport: i0, type: PbdsEmptyStateModule, imports: [[CommonModule]] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.2", ngImport: i0, type: PbdsEmptyStateModule, decorators: [{
            type: NgModule,
            args: [{
