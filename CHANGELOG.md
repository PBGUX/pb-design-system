...
- Added a new global alert component, replacing the type used in DS 4.x, the global lert is now a component inside the header component.  See the **Web > Notifications page** for details.
