...
PbdsPageTitleComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.2", ngImport: i0, type: PbdsPageTitleComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
PbdsPageTitleComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.1.2", type: PbdsPageTitleComponent, selector: "pbds-page-title", inputs: { ttl: "ttl", sub: "sub", layout: "layout" }, ngImport: i0, template: "<div class=\"page-header\">\n  <div class=\"page-title\" [ngClass]=\"layout\">\n    <div class=\"row\">\n      <div class=\"col\">\n        <h1 [ngClass]=\"{ 'mb-0': sub, 'has-sub': sub }\">{{ ttl }}</h1>\n        <h2 *ngIf=\"sub\">{{ sub }}</h2>\n      </div>\n    </div>\n  </div>\n</div>\n", styles: [".page-header h1.has-sub{margin-top:85px;margin-bottom:0}.page-title h1.mb-0+h2{font-size:16px;margin-bottom:25px;line-height:1.4}\n"], directives: [{ type: i1.NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { type: i1.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.2", ngImport: i0, type: PbdsPageTitleComponent, decorators: [{
            type: Component,
